        ...
        <main>
            ...
            <div className="pt-[105px] pl-4 pb-[234px] text-white bg-[#d9d9d9] relative">
                ...
                <div className="mt-[19px]">
                    <a href="" className="leading-[14px] rounded-[25px]
                    px-[10px] py-[8px] bg-[#B7B7B7] text-center">호텔/모텔 세탁물 전문기업</a>
                    </div>
                </div>
                    ...
                    bg-[#787878] text-center rounded-[10px] flex flex-col items-center justify-center">
                        ...
                        <span className="font-bold pt-[13.5px] block
                        text-white">전화상담</span>
                        </button>
                    </div>
                    ...
                    <div className="">
                        <button className="w-[108px] h-[108px]
                    bg-[#787878] text-center rounded-[10px] flex flex-col items-center justify-center">
                        <Image src={Kakaotalk} alt="카카오톡" className="block"></Image>
                        <span className="font-bold pt-[13.5px] block
                        text-white">카톡상담</span>
                        </button>
                    </div>
                </div>
                {/* 고객문의 */}
                ...
                <div>
                    ...
                    <div className="rounded-[10px] shadow-[0_0_10px_rgba(0,0,0,0.15)]
                    p-[25px] mt-4 flex flex-col gap-[14px]">
                        <div className="flex items-center gap-[10px]">
                            <span className="bg-[#0E5AA9]
                            p-1 text-xs rounded-[3px] text-center text-white">공지</span>
                            <p className="text-sm font-bold w-[150px] truncate">공지사항어쩌구저쩌구어쩌구저쩌구어쩌구저쩌구어쩌구저쩌구</p>
                        </div>
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-[9px]">
                            <span className="w-1 h-1 rounded-full bg-[#D9D9D9]"></span>
                            <p className="text-sm text-[#202020]">정기세탁 견적 문의드립니다</p>
                            </div>
                            <div>
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-[9px]">
                            <span className="w-1 h-1 rounded-full bg-[#D9D9D9]"></span>
                            <p className="text-sm text-[#202020]">Re:정기세탁 견적 문의드립니다</p>
                            </div>
                            <div>
                            <Image src={Lock} alt=""></Image>
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-[9px]">
                            <span className="w-1 h-1 rounded-full bg-[#D9D9D9]"></span>
                            <p className="text-sm text-[#202020] w-[210px] truncate">정기세탁 견적 문의드립니다어쩌구저쩌구저쩌구어</p>
                            </div>
                            <div>
                            <Image src={Lock} alt=""></Image>
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-[9px]">
                            <span className="w-1 h-1 rounded-full bg-[#D9D9D9]"></span>
                            <p className="text-sm text-[#202020] w-[210px] truncate">Re:정기세탁 견적 문의드립니다어쩌구저쩌구저쩌구</p>
                            </div>
                            <div>
                            <Image src={Lock} alt=""></Image>
                            </div>
                ...
                <div className="flex flex-col gap-3 w-1/2">
                    ...
                    p-[25px] flex flex-col ">
                        <div className="flex items-center gap-[10px] mb-[18px]">
                            <span className="bg-[#0E5AA9]
                            p-1 text-xs rounded-[3px] text-center text-white">공지</span>
                            <p className="text-sm font-bold w-[200px] truncate">공지사항</p>
                        </div>
                        ...
                        <div className="flex justify-between items-center mb-[14px]">
                            <div className="flex items-center gap-[9px]">
                            <span className="w-1 h-1 rounded-full bg-[#D9D9D9]"></span>
                            <p className="text-sm text-[#202020] w-[200px] truncate">정기세탁 견적 문의드립니다어쩌구저쩌구저쩌구어</p>
                            </div>
                            <div>
                            <Image src={Lock} alt=""></Image>
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-[9px]">
                            <span className="w-1 h-1 rounded-full bg-[#D9D9D9]"></span>
                            <p className="text-sm text-[#202020] w-[200px] truncate">Re:정기세탁 견적 문의드립니다어쩌구저쩌구저쩌구</p>
                            </div>
                            <div>
                            <Image src={Lock} alt=""></Image>
                            </div>
